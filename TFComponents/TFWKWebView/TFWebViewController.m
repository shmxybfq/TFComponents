...
-(void)initView{
    kdeclare_weakself;
    //初始化
    self.webView = [[TFWebView alloc] initWithFrame:CGRectZero];
...
//    }];
    ...
    //监听网页标题
    [self.webView observerTitle:^(TFWebView *webView, NSString *title) {
...
-(TFWebNavgationBar *)navgationBar{
    if (_navgationBar == nil) {
        _navgationBar = [[TFWebNavgationBar alloc]initWithFrame:CGRectZero];
    }
